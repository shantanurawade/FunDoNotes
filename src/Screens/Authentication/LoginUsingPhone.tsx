...
const LoginUsingPhone = (props: any) => {
    ...
    async function signInWithPhoneNumber(phoneNumber: string) {
        const confirmation = await auth().signInWithPhoneNumber(phoneNumber).catch((error) => {
            console.log('====================================');
            console.log(error);
            console.log('====================================');
        });
    ...
    return (
        <View>
            <TextInput value={mobile} onChangeText={(value) => setMobile(value)} style={{ marginTop: 10, marginBottom: 10 }} label="Phone" mode="outlined" ></TextInput>
            {
                isOtp ?
                    <View>
                        <TextInput value={code} onChangeText={(value) => setCode(value)} style={{ marginTop: 10, marginBottom: 10 }} label="Enter otp" mode="outlined" ></TextInput>
            ...
            {isOtp ?
                <Pressable onPress={() => { setOtp(true); confirmCode() }}
